...
## Contexto essencial
*   **Growth Loop (Selo de Conversão):** Toda vitrine pública de produto (\s*\/p\/:id\s*) deve exibir no rodapé um selo discreto e elegante: *"Venda simplificada com o CapybaraCart. Crie sua vitrine grátis."*, apontando para a landing page de conversão.
...
function extractCards(markdown) {
  ...
  for (var b = 0; b < blocks.length; b++) {
    ...
    var labels = ['Fase B']; // Label padrão para identificar a fase de construção
